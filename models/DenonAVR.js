...
exports.Model = iotdb.make_model('DenonAVR')
    ...
    .io("band",
        ...
        .enumeration(_.ld.expand([
            ...
            "iot-attribute:band.service.flickr",
            "iot-attribute:band.service.lastfm",
            "iot-attribute:band.service.napster",
            "iot-attribute:band.service.pandora",
            "iot-attribute:band.service.rhapsody",
...
exports.binding = {
    ...
    mapping: {
        band: {
            ...
            "iot-attribute:band.service.rhapsody": "RHAPSODY",
            "iot-attribute:band.service.napster": "NAPSTER",
            "iot-attribute:band.service.pandora": "PANDORA",
            "iot-attribute:band.service.lastfm": "LASTFM",
            "iot-attribute:band.service.flickr": "FLICKR",
